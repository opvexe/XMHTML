...
-(void)EX_initConfingViews{
    ...
    self.bold.contentEdgeInsets = UIEdgeInsetsMake(18, 25, 18, 25);
    ...
    self.italic.contentEdgeInsets = UIEdgeInsetsMake(18, 25, 18, 25);
    ...
    self.underline.contentEdgeInsets = UIEdgeInsetsMake(18, 25, 18, 25);
